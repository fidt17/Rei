...
namespace rei::editor
{
    ...
    private:
        ...
        void UpdateRectTransformControls(const TransformationControl& control, bool isVisible) const;
    ...
    private:
        ...
        render::Color rectCorner = render::Color::FromHex("#f2c94c");
        render::Color rectCornerBright = render::Color::FromHex("#ffd95c");
        render::Color rectEdge = render::Color::FromHex("#56ccf2");
        render::Color rectEdgeBright = render::Color::FromHex("#6bdcff");
    };
}
