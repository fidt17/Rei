...
namespace rei::editor
{
    ...
    void TransformationControlActivationSystem::OnUpdate()
    {
        ...
        else if (Input::IsKeyDown(GLFW_KEY_T) && transformationControl.HasRectTransformTargets)
        {
            transformationControl.Mode = RectTransform;
            transformationControl.UseWorldSpace = false;
        }

        if (transformationControl.Mode == RectTransform && !transformationControl.HasRectTransformTargets)
        {
            transformationControl.Mode = Movement;
        }
        ...
        else if (transformationControl.Mode == RectTransform)
        {
            DisableMovementControls(transformationControl);
            DisableScaleControls(transformationControl);
            DisableRotationControls(transformationControl);
