...
public class EditorPreferencesService : IEditorPreferencesService
{
    ...
    public ViewportGridSettings GetGridSettings()
    {
        return _preferences.GridSettings;
    }

    public void SetGridSettings(ViewportGridSettings settings)
    {
        _preferences.GridSettings = settings;
        SavePreferences(_preferences);
    }
